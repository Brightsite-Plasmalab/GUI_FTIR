...
class create_tab_ftir_fitting(QWidget):
    ...
    def create_tab(self, parent):
        ...
        self.mct_lnc_detector_bool = False
        ...
        self.layout.check_box_mct_lnc_detector = \
            QCheckBox("Is a MCT (lnc) detector used (apply heating effects in the fitting procedure)? ")
        self.layout.check_box_mct_lnc_detector.toggled.connect(self.check_box_mct_lnc_detector)
        ...
        self.layout.addWidget(self.layout.check_box_mct_lnc_detector, 6, 6, 1, 4)
    ...
    def check_box_mct_lnc_detector(self,s):
        if s:
            self.mct_lnc_detector_bool = True
        if not s:
            self.mct_lnc_detector_bool = False
    ...
    def create_inner_tabs(self, parent):
        ...
        try:
            ...
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_transmission_vs_absorbance, 12,7,1,3)
